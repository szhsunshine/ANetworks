...
class Addon_model extends CI_Model {
  ...
  public function grabClassic(){
      return $this->db->query("SELECT * FROM addons WHERE expansion = 1 AND status =2");
  }

  public function grabTbc(){
      return $this->db->query("SELECT * FROM addons WHERE expansion = 2 AND status =2");
  }


  public function grabTlk(){
      return $this->db->query("SELECT * FROM addons WHERE expansion = 3 AND status =2");
  }

  public function grabCata(){
      return $this->db->query("SELECT * FROM addons WHERE expansion = 4 AND status =2");
  }

  public function grabMop(){
      return $this->db->query("SELECT * FROM addons WHERE expansion = 5 AND status =2");
  }

  public function grabWod(){
      return $this->db->query("SELECT * FROM addons WHERE expansion = 6 AND status =2");
  }

  public function grabLegion(){
      return $this->db->query("SELECT * FROM addons WHERE expansion = 7 AND status =2");
  }
