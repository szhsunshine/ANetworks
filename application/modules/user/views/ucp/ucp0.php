...
<hr>
    <ul class="nav nav-pills nav-fill ">
      <li class="nav-item">
        <a class="nav-link active" href="<?= base_url() ?>ucp"><?= $this->lang->line('my_addons'); ?></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url() ?>ucp/pass"><?= $this->lang->line('change_pass'); ?></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url() ?>ucp/add"><?= $this->lang->line('upload_addon'); ?></a>
      </li>
    </ul>
